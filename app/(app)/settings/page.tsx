  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="font-body text-[15px] leading-relaxed tracking-[-0.01em] text-[var(--color-text-secondary)]">
      ...
      <section className="tpmi-card-surface max-w-md space-y-3 p-5">
        ...
        <p className="font-body text-[14px] leading-snug tracking-[-0.01em] text-[var(--color-text-secondary)]">
          Toggle dark mode (also available in the sidebar on desktop).
        </p>
